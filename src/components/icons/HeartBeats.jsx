const HeartBeats = ({ className = "", strokeWidth = 1 }) => {
  return (
    <svg
    ...
    >
      <g>
        <g>
          <path
            d="M502.154,181.778H384c-4.026,0-7.646,2.644-9.142,6.382l-27.714,69.383l-22.474-97.334
            ...
            stroke="currentColor" // Menggunakan warna yang sama seperti fill
